...
@interface BoxMapView()<CSAnimationSequenceDelegate>
...
- (id)initWithMap:(BoxMap*)amap
{
    ...
    if (self)
    {
        ...
        levelLabel = [[TBBrownLabel alloc] initWithFrame:levelRect];
    ...
    CSAnimationItem* moveItem = [CSAnimationItem itemWithDuration:0.25 delay:0
                                 ...
                                 ^{
                                    ...
                                    [abox setRow:ay];
                                     ...
                                     NSLog(@"======================");
                                     NSLog(@"box cell array:%d",(int)[self->boxCellArray count]);
                                     for (BoxMapCell* c in self->boxCellArray)
                                     {
